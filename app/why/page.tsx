...
export const metadata = pageMeta({
  title: "Чому JustCRM — порівняння з Clio, JuristCRM, JusNote",
  description:
    "Чесне порівняння JustCRM з міжнародними платформами (Clio), українськими CRM (JuristCRM, JusNote) та універсальними інструментами (Notion, ClickUp). AI українською, ціни у гривнях, ФОП-рахунки.",
  path: "/why",
});
...
const ALTS = [
  {
    ...
    body: "Світовий лідер legal practice management — найбагатший функціонал і велика екосистема інтеграцій.",
  ...
  {
    name: "JuristCRM",
    logos: [{ src: "vs-juristcrm.png", h: "h-9" }],
    meta: "Українська CRM · ≈200–300 ₴ / користувача",
    body: "Український інкумбент із великою клієнтською базою, локальною підтримкою і найдоступнішою ціною в сегменті. Має базовий AI-асистент.",
    fit: "Працюємо в тому ж сегменті, але робимо ставку на сучасніший інтерфейс і глибший AI українською — RAG по базі знань фірми, голос, генерація документів.",
  },
  {
    name: "JusNote",
    logos: [{ src: "vs-jusnote.png", h: "h-16" }],
    meta: "Українська CRM · від €29 / користувача",
    body: "Зрілий продукт із широким функціоналом — клієнтський портал, кореспонденція з нумерацією, мобільний застосунок. Тарифи у євро, за кожного користувача.",
    fit: "Головна різниця — вбудований AI українською, якого в JusNote немає, і сучасніший інтерфейс.",
  },
  {
    name: "Notion · ClickUp · Excel",
    logos: [
      { src: "vs-notion.png", h: "h-7" },
      { src: "vs-clickup.png", h: "h-11" },
      { src: "vs-excel.png", h: "h-8" },
    ],
    meta: "Універсальні інструменти · $0–15 / користувача",
    body: "Гнучкі й недорогі — багато юристів починають саме тут. Але вони не створені під юридичну практику: без юридичного білінгу, ФОП-рахунків і обліку справ зі строками.",
    fit: "Коли команда росте, цього стає замало. JustCRM дає ту саму простоту, але під роботу юриста.",
  },
];
