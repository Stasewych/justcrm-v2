...
export const metadata = pageMeta({
  title: "Воронка залучення клієнтів юристу",
  description: "Від першого звернення до підписання договору — структурований процес ведення потенційного клієнта у воронці юрфірми, без втрати лідів у пошті й нотатках.",
  path: "/blog/client-intake-funnel",
  type: "article",
...
export default function BlogPost() {
  return (
    <>
      <JsonLd data={blogPostGraph("client-intake-funnel")} />
      <Header />
      <GuideLines />
      <main className="flex-1 relative z-[1]">
        ...
        <article className="py-12 bg-white">
          <div className="max-w-3xl mx-auto px-8 legal-prose prose prose-neutral prose-headings:font-semibold prose-headings:tracking-tight prose-p:text-[16px] prose-p:leading-[1.8] prose-p:text-black/60 prose-li:text-[16px] prose-li:text-black/60 prose-strong:text-black/80 prose-blockquote:border-l-2 prose-blockquote:border-black/15 prose-blockquote:pl-5 prose-blockquote:text-black/50 prose-blockquote:italic">
            ...
            <TldrBox points={BLOG_TLDR["client-intake-funnel"]} />
        ...
        <RelatedPosts currentSlug="client-intake-funnel" />
