...
export default function CasesPage() {
  return (
    <>
      <JsonLd data={productGraph("Справи", "/product/cases")} />
      <FeaturePage
      ...
      faqs={productFaqs["/product/cases"]}
      relatedPosts={["kanban-case-management", "excel-to-crm-migration", "crm-vs-excel-legal"]}
      sections={[
        {
          tag: "Огляд справ",
          title: "Як зручно вести справи — Kanban, список, таблиця чи календар?",
